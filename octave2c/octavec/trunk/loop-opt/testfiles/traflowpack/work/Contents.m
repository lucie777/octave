% TraFlowPACK work-directory
%   This directory contains all the user-files (model- and problem-specifications)
%   as well as the stored data files.
%
%   TraFlowPACK initially comes with some example user-files.
%
%   See also: WORKROOT, WORKEXAMPLES
